...
namespace Loading_Screen_Hints_Module.Controls {
    public class GuessCharacter : Control {
        ...
        private Effect SilhouetteFX = GameService.Content.ContentManager.Load<Effect>(@"effects\silhouette");
        private Effect GlowFX = GameService.Content.ContentManager.Load<Effect>(@"effects\glow");
